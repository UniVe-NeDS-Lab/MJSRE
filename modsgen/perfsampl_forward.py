...
def perfect_sampling(chunk_size, ell, N, Ntries, sizes, ps, lambdas,
    ...
    for batch_index in range(num_batches):
        ...
        W = cp.zeros((current_Ntries, N), dtype=cp.float32)
        ...
        for i in range(num_chunks):
            ...
            start_offset = (2**32) - ell + chunk_size * i
            ...
            W, wasted_curr = one_sampling(current_Ntries, chunk_size, N, W, sigmas, taus, alphas, wasted_curr)
        
        # normalise the wasted capacity by the simulation length and arrival rate
        wasted_final = arr_rate * (wasted_curr / ell)
